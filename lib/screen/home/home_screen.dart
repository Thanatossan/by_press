import 'dart:io';
import 'package:by_press_cmu/screen/register/register_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        Container(
            ...
            padding: const EdgeInsets.fromLTRB(16, 100, 16, 16), //fix to all 16 when require navbar
            child: Column(
              children: [
                Container(
        ...
        children: <Widget>[
          ...
          Center(
            ...
            child: ElevatedButton(
              ...
              child: Text('เข้าสู่ระบบ', style: TextStyle(color: mThirdColor)),
            ),
          )),
        ],
      ),
  ...
  void login(String loginName, String loginSurname) async {
    ...
    if (isValid) {
      ...
      if (this.user.name != "") {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => BluetoothSetting(user: globals.user)),
